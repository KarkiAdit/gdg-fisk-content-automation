import json
from utils.samples import sample_projects

## The unprocessed processed readme, the one with base 64 image URLs
# utils/samples/unprocessed_readme_sample.md

## The processed readme, the one with public gcs image URLs
processed_readme = """
...
sample_output = sample_projects[0].to_dict()

BASE_PROJECT_TEMPLATE_VALUES = {
    "processed_readme": processed_readme,  # Contains the processed README content
    "sample_output": sample_output,        # Contains a sample output for reference
}
